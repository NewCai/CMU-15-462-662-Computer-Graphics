                                         ...
                                         Color color)
{
  ...
  // TODO: A fast implementaton of fllling rect
	...
	rasterize_line_xiaolinwu(xx1, yy1, xx2, yy2, color);
	rasterize_line_xiaolinwu(xx2, yy2, xx3, yy3, color);
	rasterize_line_xiaolinwu(xx3, yy3, xx4, yy4, color);
	rasterize_line_xiaolinwu(xx4, yy4, xx1, yy1, color);
#endif
